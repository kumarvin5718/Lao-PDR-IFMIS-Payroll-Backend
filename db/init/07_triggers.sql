-- ============================================================
-- IFMS Payroll — audit triggers on LK_* tables (Section 15.6)
-- Fires on INSERT/UPDATE to the seven lookup tables.
...
--
-- Requires: audit_log + lk_* tables (SQLAlchemy create_all) before this runs.
-- ============================================================
...
CREATE TRIGGER trg_audit_lk_location_master
    ...
    FOR EACH ROW
    EXECUTE FUNCTION fn_audit_log('province');
