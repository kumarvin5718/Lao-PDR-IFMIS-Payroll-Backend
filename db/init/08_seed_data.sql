...
VALUES
  ...
  (2,  1300001,   5000000,  5.00,        0, '5% on excess over 1.3M',   'GDT PIT Circular'),
  (3,  5000001,  12000000, 10.00,   185000, '10% on excess over 5M',    'GDT PIT Circular'),
  (4, 12000001,  25000000, 15.00,   885000, '15% on excess over 12M',   'GDT PIT Circular'),
  (5, 25000001,  65000000, 20.00,  2835000, '20% on excess over 25M',   'GDT PIT Circular'),
  (6, 65000001, 999999999, 24.00, 10835000, '24% on excess over 65M',   'GDT PIT Circular')
