...
import { Button, DatePicker, Drawer, Input, InputNumber, Select, Skeleton, Space, Table, Tag, Typography, message } from "antd";
...
import { createAllowanceRate, fetchAllowanceRates, updateAllowanceRate, type AllowanceRate } from "@/api/master";
...
export function AllowanceRatesPage() {
  ...
  const columns: ColumnsType<AllowanceRate> = [
    { title: t("master.col.allowance_name"), dataIndex: "allowance_name", key: "allowance_name" },
    {
    ...
    {
      title: t("master.col.effective_date"),
