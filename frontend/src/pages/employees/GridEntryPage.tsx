  ...
  return (
    <div style={{ padding: 24, width: "100%", maxWidth: "100%" }}>
      ...
      <Typography.Text type="secondary" style={{ fontSize: 12, display: "block", marginBottom: 8 }}>
        Tip: Scroll horizontally to see all columns. Click a cell to edit. Use Tab to move to next cell.
      </Typography.Text>

      {batchResult && batchResult.skipped > 0 && !errorModalOpen ? (
        <Collapse defaultActiveKey={["skipped"]} style={{ marginBottom: 12 }}>
          <Collapse.Panel header={`Skipped rows (${batchResult.skipped})`} key="skipped">
            <Table
              size="small"
              pagination={false}
              scroll={{ x: true }}
              ...
              columns={[
                ...
                { title: "Hint", dataIndex: "hint", key: "hint", width: 260 },
              ]}
            />
          </Collapse.Panel>
        </Collapse>
