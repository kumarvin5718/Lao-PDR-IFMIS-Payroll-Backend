...
function parseMasterOrg(data: unknown): string[] {
  if (!data || typeof data !== "object") return [];
  if (Array.isArray(data)) {
    if (data.length === 0) return [];
    if (typeof data[0] === "string") return data as string[];
    return (data as { ministry_name?: string }[])
...
function parseMasterLocation(data: unknown): string[] {
  if (!data || typeof data !== "object") return [];
  if (Array.isArray(data)) {
    return (data as { province?: string }[])
      .map((x) => x.province)
      .filter((x): x is string => Boolean(x));
  }
  return [];
...
function parseMasterBank(data: unknown): string[] {
  if (!data || typeof data !== "object") return [];
  if (Array.isArray(data)) {
    return (data as { bank_name?: string }[])
      .map((x) => x.bank_name)
      .filter((x): x is string => Boolean(x));
  }
  return [];
...
function parseAllowanceRates(data: unknown): string[] {
  if (!data || typeof data !== "object") return [];
  if (Array.isArray(data)) {
    return (data as { allowance_name?: string }[])
...
export function EmployeeFormPage() {
  ...
  const { data: ministries = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      return parseMasterOrg(data.data);
    },
  });
  ...
  const { data: allowanceNames = [] } = useQuery({
    queryKey: ["master", "allowance-rates"],
    queryFn: async () => {
  ...
  const { data: derivedGrade, isFetching: deriving } = useQuery({
    queryKey: ["grade-derivation", educationLevel, priorExp, yos],
    queryFn: async () => {
      const { data } = await apiClient.get<ApiEnvelope<{ grade?: number; step?: number }>>(
        "/api/v1/master/grade-derivation",
        {
          params: {
      ...
      >
          ...
          items={[
            {
              ...
              children: (
                <Row gutter={[16, 16]}>
                  {!isEdit && (
                    <Col xs={24} md={12}>
                      <Form.Item label={LABEL_REQ(t("employee.f_employee_code", { defaultValue: "Employee code" }))}>
                        <Controller
                          name="employee_code"
                          control={control}
                          render={({ field }) => (
                            <Input {...field} {...inputProps("employee_code")} placeholder="LAO00001" />
                          )}
                        />
                      </Form.Item>
                    </Col>
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_title", { defaultValue: "Title" }))}>
                      <Controller
                        name="title"
                        control={control}
                        render={({ field }) => (
                          <Select
                            {...field}
                            options={["Mr.", "Ms.", "Mrs.", "Dr.", "Prof."].map((x) => ({
                              label: x,
                              value: x,
                            }))}
                            style={{ width: "100%" }}
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_first_name", { defaultValue: "First name" }))}>
                      <Controller
                        name="first_name"
                        control={control}
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_last_name", { defaultValue: "Last name" }))}>
                      <Controller
                        name="last_name"
                        control={control}
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_gender", { defaultValue: "Gender" }))}>
                      <Controller
                        name="gender"
                        control={control}
                        render={({ field }) => (
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_dob", { defaultValue: "Date of birth" }))}>
                      <Controller
                        name="date_of_birth"
                        control={control}
                        render={({ field }) => (
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_email", { defaultValue: "Email" }))}>
                      <Controller
                        name="email"
                        control={control}
                        render={({ field }) => (
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={t("employee.f_mobile", { defaultValue: "Mobile" })}>
                      <Controller
                        name="mobile_number"
                        control={control}
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_csc", { defaultValue: "Civil Service Card ID" }))}>
                      <Controller
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={t("employee.f_sso", { defaultValue: "SSO Number" })}>
                      <Controller
                        name="sso_number"
                        control={control}
                        render={({ field }) => (
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_employment_type", { defaultValue: "Employment type" }))}>
                      <Controller
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_doj", { defaultValue: "Date of joining" }))}>
                      <Controller
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_position_title", { defaultValue: "Position title" }))}>
                      <Controller
                        name="position_title"
                        control={control}
                  ...
                  <Col span={24}>
                    ...
                    >
                      <div>
                        ...
                        {t("employee.years_suffix", { defaultValue: "years" })}
                      </div>
                      <div>
            ...
            },
            {
              ...
              children: (
                <Row gutter={[16, 16]}>
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_education", { defaultValue: "Education level" }))}>
                      <Controller
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={t("employee.f_prior_exp", { defaultValue: "Prior experience (years)" })}>
                      <Controller
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_position_level", { defaultValue: "Position level" }))}>
                      <Controller
                        name="position_level"
                        control={control}
                        render={({ field }) => (
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_profession", { defaultValue: "Profession category" }))}>
                      <Controller
                  ...
                  <Col span={24}>
                    <Typography.Paragraph type="secondary" style={{ marginBottom: 8 }}>
                      {t("employee.grade_blurb", {
                        defaultValue:
                          "Grade and step are derived automatically from education level, prior experience, and years of service.",
                      })}
            ...
            },
            {
              ...
              children: (
                <Row gutter={[16, 16]}>
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_ministry", { defaultValue: "Ministry" }))}>
                      <Controller
                        name="ministry_name"
                        control={control}
                        render={({ field }) => (
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_department", { defaultValue: "Department" }))}>
                      <Controller
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={t("employee.f_division", { defaultValue: "Division" })}>
                      <Controller
                        name="division_name"
                        control={control}
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_service_country", { defaultValue: "Service country" }))}>
                      <Controller
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={LABEL_REQ(t("employee.f_service_province", { defaultValue: "Service province" }))}>
                      <Controller
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={t("employee.f_service_district", { defaultValue: "Service district" })}>
                      <Controller
                  ...
                  <Col xs={24} md={8}>
                    <Form.Item label={t("employee.f_remote", { defaultValue: "Remote area" })}>
                      <Controller
                        name="is_remote_area"
                        control={control}
                        render={({ field }) => (
                    ...
                    <Typography.Text type="secondary" style={{ fontSize: 12 }}>
                      {t("employee.province_auto_hint", {
                        defaultValue: "(Auto-set from province classification. Can be overridden.)",
                      })}
                    </Typography.Text>
                  </Col>
                  <Col xs={24} md={8}>
                    <Form.Item label={t("employee.f_foreign", { defaultValue: "Foreign posting" })}>
                      <Controller
                  ...
                  <Col xs={24} md={8}>
                    <Form.Item label={t("employee.f_hazard", { defaultValue: "Hazardous area" })}>
                      <Controller
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={t("employee.f_na", { defaultValue: "National Assembly member" })}>
                      <Controller
                        name="is_na_member"
                        control={control}
                        render={({ field }) => (
            ...
            },
            {
              ...
              children: (
                <>
                  <Typography.Title level={5}>{t("employee.bank_section", { defaultValue: "Bank details" })}</Typography.Title>
                  <Row gutter={[16, 16]}>
                    <Col xs={24} md={12}>
                      <Form.Item label={LABEL_REQ(t("employee.f_bank", { defaultValue: "Bank name" }))}>
                        <Controller
                          name="bank_name"
                          control={control}
                          render={({ field }) => (
                    ...
                    <Col xs={24} md={12}>
                      <Form.Item label={LABEL_REQ(t("employee.f_branch", { defaultValue: "Bank branch" }))}>
                        <Controller
                          name="bank_branch"
                          control={control}
                          render={({ field }) => {
                            ...
                            <Select
                              ...
                              placeholder={
                                bankNameWatch?.trim()
                                  ? t("employee.f_branch", { defaultValue: "Bank branch" })
                                  : t("employee.select_bank_first", { defaultValue: "Select bank first" })
                              }
                    ...
                    <Col xs={24} md={12}>
                      <Form.Item label={t("employee.f_branch_code", { defaultValue: "Branch code" })}>
                        <Controller
                    ...
                    <Col xs={24} md={12}>
                      <Form.Item label={LABEL_REQ(t("employee.f_account", { defaultValue: "Account number" }))}>
                        <Controller
                    ...
                    <Col xs={24} md={12}>
                      <Form.Item label={t("employee.f_swift", { defaultValue: "SWIFT" })}>
                        <Controller
                          name="swift_code"
                          control={control}
                  ...
                  <Divider />
                  <Typography.Title level={5}>{t("employee.family_section", { defaultValue: "Family" })}</Typography.Title>
                  <Row gutter={[16, 16]}>
                    <Col xs={24} md={12}>
                      <Form.Item label={t("employee.f_spouse", { defaultValue: "Has spouse" })}>
                        <Controller
                          name="has_spouse"
                          control={control}
                          render={({ field }) => (
                    ...
                    <Col xs={24} md={12}>
                      <Form.Item label={t("employee.f_children", { defaultValue: "Eligible children" })}>
                        <Controller
                    ...
                    <Col xs={24} md={12}>
                      <Form.Item label={t("employee.f_field_allowance", { defaultValue: "Field allowance" })}>
                        <Controller
                ...
                <Row gutter={[16, 16]}>
                  {(
                    ...
                    <Col xs={24} md={12} key={name}>
                      <Form.Item label={t(`employee.f_${name}`, { defaultValue: lab })}>
                        <Controller
                          name={name}
                          control={control}
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={t("employee.f_province_of_residence", { defaultValue: "Province" })}>
                      <Controller
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={t("employee.f_pin_code", { defaultValue: "PIN" })}>
                      <Controller
                        name="pin_code"
                        control={control}
                  ...
                  <Col xs={24} md={12}>
                    <Form.Item label={t("employee.f_residence_country", { defaultValue: "Country" })}>
                      <Controller
        ...
        >
          ...
          <Space>
            ...
            >
              {isEdit ? t("employee.save_changes", { defaultValue: "Save Changes" }) : t("employee.add_submit", { defaultValue: "Add Employee" })}
            </Button>
          </Space>
        </div>
      </form>
