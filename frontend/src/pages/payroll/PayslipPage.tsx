...
export function PayslipPage() {
  ...
  if (payrollQ.isError || !row) {
    return (
      <div style={{ padding: 24 }}>
        <Typography.Text type="danger">Payslip not found.</Typography.Text>
      </div>
    );
  }
    ...
    <div style={{ background: "#F7F8FA", minHeight: "100%", padding: "1rem" }}>
      ...
      >
        ...
        {emp && (
          ...
          >
            <div>
              <div style={{ color: "#7A8599", marginBottom: 4 }}>Name</div>
              <div>
                {emp.title} {emp.first_name} {emp.last_name}
              </div>
              <div style={{ color: "#7A8599", marginTop: 8, marginBottom: 4 }}>Position</div>
              <div>{emp.position_title}</div>
              <div style={{ color: "#7A8599", marginTop: 8, marginBottom: 4 }}>Ministry</div>
              <div>{emp.ministry_name}</div>
              <div style={{ color: "#7A8599", marginTop: 8, marginBottom: 4 }}>Department</div>
              <div>{emp.department_name}</div>
            </div>
            <div>
              <div style={{ color: "#7A8599", marginBottom: 4 }}>Grade / Step</div>
              <div>
                G{emp.grade}/S{emp.step}
              </div>
              <div style={{ color: "#7A8599", marginTop: 8, marginBottom: 4 }}>Employment</div>
              <div>{emp.employment_type}</div>
              <div style={{ color: "#7A8599", marginTop: 8, marginBottom: 4 }}>Civil Service Card</div>
              <div>{emp.civil_service_card_id}</div>
              <div style={{ color: "#7A8599", marginTop: 8, marginBottom: 4 }}>Join date</div>
