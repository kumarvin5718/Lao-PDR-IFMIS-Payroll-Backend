...
class PayrollFreeFieldPatch(BaseModel):
    ...
    other_allowance_1_desc: str | None = None
    other_allowance_2_desc: str | None = None
    other_allowance_3_desc: str | None = None
    addl_deduction_1_desc: str | None = None
    addl_deduction_2_desc: str | None = None
...
class PayrollMonthlyOut(BaseModel):
    ...
    free_allowance_1_desc: str | None = None
    free_allowance_2_desc: str | None = None
    free_allowance_3_desc: str | None = None
    free_deduction_1_desc: str | None = None
    free_deduction_2_desc: str | None = None
    net_salary: Decimal
    status: str
