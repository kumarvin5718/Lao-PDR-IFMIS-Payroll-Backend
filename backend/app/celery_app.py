"""Celery application: broker/result, included task modules, beat schedule, import side effects."""
...
celery_app.conf.update(
    ...
    enable_utc=False,
    broker_connection_retry_on_startup=_env_bool("CELERY_BROKER_CONNECTION_RETRY_ON_STARTUP"),
    beat_schedule={
        "archive-old-payroll": {
