/** Route table: protected layouts, role gates, lazy navigation targets. */
...
import { MinistryMasterPage } from "@/pages/master/MinistryMasterPage";
...
const MINISTRY_MASTER_ROLES = [ROLES.DEPT_OFFICER, ROLES.ADMIN];
  ...
  return (
    <Routes>
      ...
      >
        ...
        />
        <Route
          path="master/ministry"
          element={
            <ProtectedRoute roles={MINISTRY_MASTER_ROLES}>
              <MinistryMasterPage />
            </ProtectedRoute>
          }
        />
