/** Screen: `PITBracketsPage` — page-level UI and mutations. */
...
export function PITBracketsPage() {
  ...
  const q = useQuery({
    queryKey: ["master", "pit-brackets", page, pageSize, debouncedSearch],
    queryFn: async () => {
  ...
  return (
    <div style={{ background: "#F7F8FA", minHeight: "100%", padding: "1rem" }}>
      ...
      >
        ...
        <Input.Search
          allowClear
          placeholder={t("pitBrackets.searchPlaceholder")}
          value={searchInput}
        ...
        >
          <Table<PITBracket>
            ...
            pagination={{
              ...
              showTotal: (total) => t("pitBrackets.totalRows", { count: total }),
