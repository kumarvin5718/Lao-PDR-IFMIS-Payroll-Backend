...
export interface PayrollMonthlyRow {
  ...
  free_allowance_1_desc?: string | null;
  free_allowance_2_desc?: string | null;
  free_allowance_3_desc?: string | null;
  free_deduction_1_desc?: string | null;
  free_deduction_2_desc?: string | null;
  gross_salary: number;
  employee_sso: number;
  employer_sso: number;
...
export async function patchFreeFields(
  ...
  body: {
    ...
    free_deduction_1?: number;
    free_deduction_2?: number;
    other_allowance_1_desc?: string | null;
    other_allowance_2_desc?: string | null;
    other_allowance_3_desc?: string | null;
    addl_deduction_1_desc?: string | null;
    addl_deduction_2_desc?: string | null;
  },
