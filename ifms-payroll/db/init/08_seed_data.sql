...
-- MoF 4904/MOF Jan 2026. Bracket 6: use numeric sentinel 999999999 so INSERT succeeds on
-- legacy DBs where income_to_lak is still NOT NULL; API treats huge values as open-ended.
-- After 005_align_legacy_schema.sql, NULL is also allowed for bracket 6.
...
VALUES
  ...
  (6, 40000001, 999999999, 24.00,  6185000, '24% on amount over 40,000,000', '2026-01-01', 'GDT / MoF PIT Rates (current)')
