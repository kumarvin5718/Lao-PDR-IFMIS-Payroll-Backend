...
-- (aligned to GDT cumulative amounts; not 1300001/5000001 which skew marginal totals by 1 LAK per band)
INSERT INTO lk_pit_brackets
  (bracket_no, income_from_lak, income_to_lak, rate_pct, cumulative_tax_lak, description, circular_ref)
VALUES
  (1,        0,   1300000,  0.00,        0, 'Exempt',                    'GDT PIT Circular'),
  (2,  1300000,   5000000,  5.00,        0, '5% on excess over 1.3M',   'GDT PIT Circular'),
  (3,  5000000,  12000000, 10.00,   185000, '10% on excess over 5M',    'GDT PIT Circular'),
  (4, 12000000,  25000000, 15.00,   885000, '15% on excess over 12M',   'GDT PIT Circular'),
  (5, 25000000,  65000000, 20.00,  2835000, '20% on excess over 25M',   'GDT PIT Circular'),
  (6, 65000000, 999999999, 24.00, 10835000, '24% on excess over 65M',   'GDT PIT Circular')
ON CONFLICT (bracket_no) DO NOTHING;
