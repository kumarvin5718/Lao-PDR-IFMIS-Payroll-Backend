...
async def _calculate_one(
    ...
    profession_all = await _get_allowance_rate(db, emp.profession_category, basic)
...
async def payroll_row_to_out(
    ...
    housing_d, transport_d = housing_transport_from_fuel(fuel_stored, housing_r, transport_r)
