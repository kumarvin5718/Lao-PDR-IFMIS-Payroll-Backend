"""Lookup: personal income tax brackets and rates (GDT-aligned)."""
...
class LkPitBrackets(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "income_to_lak IS NULL OR income_to_lak > income_from_lak",
            name="ck_lk_pit_range",
        ),
    )
    ...
    income_to_lak: Mapped[float | None] = mapped_column(Numeric(15, 0), nullable=True)
