"""Lookup: geographic hierarchy (country, province, district) for employee posting."""
...
class LkLocationMaster(Base):
    ...
    district_key: Mapped[str] = mapped_column(String(16), primary_key=True)
    country: Mapped[str] = mapped_column(String(30), nullable=False)
    country_key: Mapped[str] = mapped_column(String(10), nullable=False)
    province_key: Mapped[str] = mapped_column(String(10), nullable=False)
    province: Mapped[str] = mapped_column(String(60), nullable=False, index=True)
