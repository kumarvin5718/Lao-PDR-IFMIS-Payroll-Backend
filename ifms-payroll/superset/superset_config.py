"""Apache Superset runtime config for Docker (embedded dashboards, guest tokens, RLS).

Mounted at `/superset` behind nginx; CORS allows `api:8000` to mint guest tokens.
"""
