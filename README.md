...
**New developer or fresh environment?** You do not need any prior deployment or database volume. Configure **`.env`**, start **Docker Compose**, then run **`scripts/first_deploy_apply_database.sh`** — see **[`deploy/README.md`](deploy/README.md)** for the full sequence, ports, and troubleshooting.
